...
builder.Services.AddScoped<GuestDiscountTierRepository>();
builder.Services.AddScoped<ServiceExtraChargeCatalogRepository>();
...
builder.Services.AddScoped<IServiceExtraChargeCatalogService, ServiceExtraChargeCatalogService>();
builder.Services.AddScoped<IGuestDiscountTierService, GuestDiscountTierService>();
...
builder.Services.AddScoped<ExpoPushProvider>();
