...
namespace BookfetSystem.Services.Interface
{
    public interface IOrderDetailStaffTaskService
    {
        ...
        Task<ApiResponse<OrderDetailStaffTaskResponse>> AcceptMyTaskAsync(int taskId, int staffId);
        Task<ApiResponse<OrderDetailStaffTaskResponse>> CompleteMyTaskAsync(int taskId, int staffId, StaffCompleteTaskRequest request);
